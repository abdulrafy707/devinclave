      ...
      <section className="relative bg-white py-12">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 relative px-6 md:px-12">
            ...
            <div className="absolute z-40 bottom-0 right-0 transform translate-x-10 translate-y-10">
              <div className="bg-yellow-500 text-white flex flex-col text-center font-bold rounded-full p-4 w-48 h-48 flex items-center justify-center shadow-lg">
                {/* <div className="text-lg">3+</div> */}
                <div className="text-3xl">3+ Years of</div>
