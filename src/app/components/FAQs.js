...
export default function FAQ() {
  const faqs = [
    {
      question: "How does Div Enclave help brands build personal relationships with their customers?",
      answer:
    ...
    {
      question: "What sets Div Enclave apart from other digital agencies?",
      answer:
    ...
    {
      question: "Can you provide examples of successful projects Div Enclave has completed?",
      answer:
    ...
    {
      question: "How does Div Enclave ensure the security and scalability of its web solutions?",
      answer:
    ...
    {
      question: "What is Div Enclave's approach to pricing and project timelines?",
      answer:
    ...
    {
      question: "How can I get started with Div Enclave on my next digital project?",
      answer:
