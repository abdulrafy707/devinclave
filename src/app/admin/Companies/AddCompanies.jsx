    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ value }) => {
          return (
            <img
              src={`https://divenclave.com/uploads/${value.trim()}`}
              alt="Company Logo"
                    ...
                    <img
                      src={
                        editingCompany.comp_logo instanceof File
                          ...
                          : `https://divenclave.com/uploads/${editingCompany.comp_logo}`
                      }
                      alt="Uploaded"
                      style={{
                        maxWidth: "100px",
        ...
        <DialogContent>
          {deleteConfirmation.id && (
            <Typography variant="body1">
              Are you sure you want to delete the company with ID {deleteConfirmation.id}?
            </Typography>
          )}
        </DialogContent>
        <DialogActions>
