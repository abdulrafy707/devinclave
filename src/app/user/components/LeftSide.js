  ...
  return (
    <div className="w-full md:w-3/3 p-6 bg-white rounded-lg shadow-lg space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-500">{company?.comp_description || 'SuperMade discount codes for 40% OFF are issued by this store for Limited Time. You can use these Coupon codes to get upto 70% discount in August 2024.'}</p>
      </div>

      {/* Discount Code Summary */}
      <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
        <h3 className="text-lg font-semibold mb-4">SuperMade Discount Code Summary</h3>
        ...
        <p className="text-purple-600 mt-4 underline cursor-pointer">Coupon Codes &gt; SuperMade Discount Code</p>
      </div>

      {/* Categories */}
      <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
        <h3 className="text-lg font-semibold mb-4">SuperMade Categories</h3>
      ...
      {/* Similar Promo Codes */}
      <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
        <h3 className="text-lg font-semibold mb-4">Stores with SuperMade-Like Promo Codes</h3>
        <ul className="space-y-2 text-gray-600">
